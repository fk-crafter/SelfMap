  ...
  return (
    <section className="relative z-10 mt-32 flex w-full max-w-6xl flex-col items-center px-6">
      ...
      <div className="grid w-full auto-rows-85 grid-cols-1 gap-6 md:grid-cols-3">
        ...
        >
          <MagicCard gradientColor="rgba(197, 192, 254, 0.15)" className="group flex h-full flex-col justify-between overflow-hidden border-white/5 bg-[rgba(197,192,254,0.02)] backdrop-blur-xl">
            <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-[#c5c0fe] opacity-10 blur-[60px] transition-opacity group-hover:opacity-20 z-0" />
        ...
        >
          <MagicCard gradientColor="rgba(201, 235, 208, 0.15)" className="group flex h-full flex-col overflow-hidden border-white/5 bg-[rgba(197,192,254,0.02)] backdrop-blur-xl !p-0">
        ...
        >
          <MagicCard gradientColor="rgba(233, 195, 73, 0.15)" className="group flex h-full flex-col justify-between overflow-hidden border-[#e9c349]/20 bg-[rgba(233,195,73,0.02)] transition-colors hover:bg-[rgba(233,195,73,0.05)] backdrop-blur-xl">
            <div className="relative z-10 flex flex-col justify-between h-full">
              <div>
              ...
              <div className="text-5xl font-serif text-[#e9c349] opacity-80 mt-4">
                87%
              </div>
            </div>
          </MagicCard>
        ...
        >
          <MagicCard gradientColor="rgba(201, 235, 208, 0.15)" className="group flex h-full flex-col justify-between overflow-hidden border-white/5 bg-[rgba(197,192,254,0.02)] backdrop-blur-xl">
            <div className="relative z-10 flex flex-col justify-between h-full">
              <div>
