...
export function ValueProposition() {
  ...
  return (
    <section className="relative z-10 mt-24 sm:mt-32 flex w-full max-w-5xl flex-col items-center px-4 sm:px-6">
      <motion.div
      ...
      <div className="mx-auto flex w-full flex-col gap-6 lg:grid lg:grid-cols-[1fr_auto_1.1fr] lg:items-stretch lg:gap-6">
        <motion.div
        ...
        >
          <Card className="flex w-full flex-col border border-white/5 bg-[rgba(197,192,254,0.01)] p-6 sm:p-8 opacity-80 backdrop-blur-md transition-opacity duration-300 hover:opacity-100 lg:p-10">
            ...
            >
              <motion.li
                ...
                className="flex items-start gap-3 text-sm sm:text-base text-[#c8c5d0]/50"
              >
        ...
        <div className="flex w-full items-center justify-center my-2 lg:hidden">
          <div className="flex items-center gap-4 w-full">
            <div className="h-px flex-1 bg-linear-to-r from-transparent via-[#e9c349]/30 to-transparent" />
            <div className="flex h-8 w-8 items-center justify-center rounded-full border border-[#e9c349]/30 bg-[#001809] text-[10px] font-bold text-[#c8c5d0]">
              VS
            </div>
            <div className="h-px flex-1 bg-linear-to-r from-transparent via-[#e9c349]/30 to-transparent" />
          </div>
        ...
        >
          <motion.div
            ...
            className="flex w-full"
          >
            <Card className="group relative flex w-full flex-col overflow-hidden border border-[#e9c349]/30 bg-linear-to-b from-[#e9c349]/10 to-transparent p-6 sm:p-8 shadow-[0_0_40px_rgba(233,195,73,0.1)] backdrop-blur-xl transition-all duration-500 hover:border-[#e9c349]/60 hover:shadow-[0_0_60px_rgba(233,195,73,0.2)] lg:scale-105 lg:p-10">
              ...
              <div className="mb-6 flex items-center gap-4">
                <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-xl bg-[#e9c349]/20 text-[#e9c349] shadow-[0_0_15px_rgba(233,195,73,0.2)]">
              ...
              >
                <motion.li
                  variants={itemVariants}
                  className="flex items-start gap-4 text-sm sm:text-lg text-[#c9ebd0]"
                >
