    ...
    <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-[#001809] font-sans text-[#c9ebd0]">
      ...
      <main className="prose prose-invert prose-headings:font-serif prose-headings:text-[#c9ebd0] prose-p:text-[#c8c5d0] prose-a:text-[#e9c349] relative z-10 mx-auto w-full max-w-4xl px-6 pb-32 pt-32 md:px-12">
        ...
        <section className="space-y-6">
          ...
          <p>
            By accessing or using the SoulType service, you agree to be bound by
          ...
          <p>
            SoulType provides an AI-powered psychological assessment and
            conversational coaching platform. The coaching provided by the AI is
            for informational and self-reflection purposes only and does not
            substitute professional mental health advice, diagnosis, or
            treatment.
          </p>
          ...
          <p>
            Certain aspects of the Service are billed on a subscription basis
            ("Awakened" tier). You will be billed in advance on a recurring and
          ...
          <p>
            ...
            property of SoulType and its licensors. The Service is protected by
            copyright, trademark, and other laws.
          </p>

          <h2>6. Limitation of Liability</h2>
          <p>
            In no event shall SoulType, nor its directors, employees, partners,
