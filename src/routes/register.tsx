  ...
  return (
    <div className="flex h-dvh w-full flex-col items-center justify-center overflow-hidden bg-[#EAE8EF]/50 p-4">
      <div className="w-full max-w-[400px] rounded-3xl bg-[#F9F8FC] p-6 shadow-2xl shadow-[#1D1B4B]/10 sm:p-8">
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-3">
          ...
          <div className="mt-1 flex items-start gap-2">
            <input
              ...
              className="mt-0.5 h-3.5 w-3.5 shrink-0 rounded border-gray-300 text-[#1D1B4B] focus:ring-[#1D1B4B]"
            />
            <label
              htmlFor="terms"
              className="text-xs font-medium leading-tight text-[#1A1A1A]/60"
            >
              I agree to the{' '}
              <a href="#" className="font-bold text-[#1D1B4B] hover:underline">
                Terms of Service
              </a>{' '}
              &{' '}
              <a href="#" className="font-bold text-[#1D1B4B] hover:underline">
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="mt-1 flex h-12 w-full items-center justify-center rounded-full bg-[#1D1B4B] text-sm font-semibold text-white shadow-md transition-all hover:bg-[#1D1B4B]/90 active:scale-[0.98]"
          >
            {isLoading ? (
        ...
        <div className="mt-5 text-center text-xs font-medium text-[#1A1A1A]/60">
      ...
      <div className="mt-4 flex shrink-0 items-center justify-center gap-6 text-[10px] font-semibold text-[#1A1A1A]/50 sm:text-xs">
